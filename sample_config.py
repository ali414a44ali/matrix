...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://repl.it/@BiLaLn/stringsession
    ...
    # set this with required dev repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/ali414a44ali/matrix"
    )
    ...
    OLDdev = os.environ.get("OLDdev", "no")
    OLDdev = bool(OLDdev and (OLDdev.lower() != "no"))
    ...
    MatrixAL_A = os.environ.get("MatrixAL_A", "@Matrixao")
    ...
    OLDdev_REPO = os.environ.get("OLDdev_REPO", "https://github.com/BDB0B-Ar/ZTZ")
    if OLDdev_REPO and not url(OLDdev_REPO):
        OLDdev_REPO = "https://github.com/BDB0B-Ar/ZTZ"
    OLDdev_REPOBRANCH = os.environ.get("OLDdev_REPOBRANCH", "olddev")
    VC_REPO = os.environ.get("VC_REPO", "https://github.com/dev-Thon/ZVCPlayer")
