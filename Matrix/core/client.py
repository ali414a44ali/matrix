...
ZDEV = (7291869416, 6454554515, 315153481)
...
class devUserBotClient(TelegramClient):
    def dev_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @o_p_g\
            ...
            if pattern is not None:
                ...
                if edited:
                    blal.add_event_handler(func, events.MessageEdited(**kwargs))
                blal.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                blal.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                blal.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
devUserBotClient.fast_download_file = download_file
devUserBotClient.fast_upload_file = upload_file
devUserBotClient.reload = restart_script
devUserBotClient.get_msg_link = get_message_link
devUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    devUserBotClient.send_message = send_message
    devUserBotClient.send_file = send_file
    devUserBotClient.edit_message = edit_message
