...
@blal.on(events.NewMessage(pattern=r'\.صنع بوت (.*)'))
...
@blal.on(events.NewMessage(pattern=r'\.تحكم (@?\w+)'))
...
@blal.on(events.CallbackQuery(data=b"change_name"))
...
@blal.on(events.CallbackQuery(data=b"change_desc"))
...
@blal.on(events.CallbackQuery(data=b"change_pic"))
...
@blal.on(events.CallbackQuery(data=b"delete_bot"))
...
@blal.on(events.CallbackQuery(data=b"confirm_delete"))
...
@blal.on(events.CallbackQuery(data=b"cancel_delete"))
...
@blal.on(events.CallbackQuery(data=b"get_token"))
