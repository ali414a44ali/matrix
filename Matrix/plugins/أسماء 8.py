...
from Matrix.core.managers import edit_delete, edit_or_reply
from Matrix.sql_helper.globals import addgvar, gvarstatus
...
@blal.dev_cmd(
    pattern="اسمي عفرتو$",
    command=("اسمي عفرتو", plugin_category),
    info={
...
async def pussy(event):
    ...
    await edit_or_reply(event, "**جـاري وضع اسم عفرتو على حسابـك**")
