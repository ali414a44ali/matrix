...
@blal.dev_cmd(pattern=f"({DART_E_MOJI}|سهم)( ([1-6])|$)")
async def _(event):
    if event.fwd_from:
        return
    reply_message = event
...
@blal.dev_cmd(pattern=f"({DICE_E_MOJI}|نرد)( ([1-6])|$)")
async def _(event):
    if event.fwd_from:
        return
    reply_message = event
...
@blal.dev_cmd(pattern=f"({BALL_E_MOJI}|سله)( ([1-5])|$)")
async def _(event):
    if event.fwd_from:
        return
    reply_message = event
...
@blal.dev_cmd(pattern=f"({FOOT_E_MOJI}|.كرة)( ([1-5])|$)")
async def _(event):
    if event.fwd_from:
        return
    reply_message = event
...
@blal.dev_cmd(pattern=f"({SLOT_E_MOJI}|حظ)( ([1-64])|$)")
async def _(event):
    if event.fwd_from:
        return
    reply_message = event
