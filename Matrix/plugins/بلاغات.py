...
""" 
Abuse Notifications for BDB0B™ t.me/BiLaL
...
async def spam_abusedev(event, sandy, dev, sleeptimem, sleeptimet, DelaySpam=False):
    # sourcery no-metrics
    counter = int(dev[0])
    if len(dev) == 2:
