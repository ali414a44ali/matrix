...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 - حفـظ الذاتـيـة ♥️](t.me/Matrix) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
...
async def oho(event):
    ...
    await blal.send_file("me", pic, caption=f"**𓆰تم حفـظ الصـورة الذاتـيـة .. بنجـاح ☑️𓆰**")
    await event.delete()
