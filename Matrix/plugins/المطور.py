...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗧𝞝𝗣 𓆪 </b> - @Matrix "
...
async def who(event):
    ...
    zel_dev = (7291869416, 54262739871)
    ...
    if replied_user.id in zel_dev:
       return await edit_or_reply(dev, "**- عذرًا . . انـهُ احـد المطـورين . . عيب**")
    if replied_user.id == 7291869416 or replied_user.id == 6367373783 or replied_user.id == 23839374791:
       return await edit_or_reply(dev, "**- عذرًا . . انـهُ المطـور . . عيب**")
