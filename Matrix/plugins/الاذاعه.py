...
ZelzalPRO_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامـر الاذا؏ـــة](t.me/Matrix) 𓆪\n\n"
...
@blal.dev_cmd(pattern=f"للمجموعات(?: |$)(.*)")
async def gcast(event):
    BiLaL = event.pattern_match.group(1)
    if BiLaL: #Write Code By T.me/zzzzl1l
        await edit_or_reply(event, "**𓆰 بالـࢪد ؏ــلى ࢪسـالة او وسائـط**")
...
async def pmto(event):
    ...
    if zelzal == "":
        return
    try:
        await blal.send_message(chat_id, zelzal)
