...
# بلاي 
M = (
    "**𓆰**  𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━─━─━─━─𝙕─━─━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 **⪼**  [𐇮 𝙕𝞝𝙇𝙕𝘼𝙇 آلـۘهہؚيـٰـُ͢ـُ໋۠بـ໋ۘ۠ه 𐇮](t.me/bdb0b)   \n"
    "**𓆰** 𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ **⪼**  [𝙕𝙏𝙃𝙊𝙉](https://t.me/BDB0B)  "
)
...
@blal.dev_cmd(
    ...
    info={
        "header": "العـاب الانـلاين لـ سـورس ماتركس",
        "الاستـخـدام": "{tr}بلاي",
    },
)
async def devrepo(zelp):
