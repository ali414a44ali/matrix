...
MatrixalPH_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝙈𝙖𝙏𝙍𝙞𝙭 ⌁ 📲 - كـاشـف الارقـام العربيــة](t.me/BDB0B) 𓆪\n\n"
    "**⪼ الامــر ↵**\n\n"
...
async def _(event): #Code by T.me/zzzzl1l
    ...
    Matrixal = "@ZZIIIbot" #Code by T.me/zzzzl1l
    dev = await edit_or_reply(event, "**⎉╎جـارِ الكشـف عن الرقـم 📲**\n**⎉╎انتظـر قليـلاً ... ▬▭**")
    async with borg.conversation(Matrixal) as conv: # code by t.me/zzzzl1l
        try:
...
@blal.dev_cmd(pattern="الكاشف")
async def cmd(Matrixallll):
    await edit_or_reply(Matrixallll, MatrixalPH_cmd)
