# animation5 for BDB0B edit by ~ @zlzzl77
...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "BDB0B"


@blal.dev_cmd(pattern="رقص$")
async def _(event):
