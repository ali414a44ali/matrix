...
async def writer(e):
    ...
    img = Image.open("devthon/malath/ppmsg.jpg")
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("devthon/malath/zarz.ttf", 30)
    x, y = 150, 140
    lines = text_set(text)
