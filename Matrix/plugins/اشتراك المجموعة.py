...
# <https://www.github.com/dev-Thon/ZelZal/blob/Tepthon/LICENSE/>.
...
#                                                  الملـــف كتـــابـــة  - t.me/BDB0B                                    #
...
@blal.on(events.NewMessage(pattern=None))
