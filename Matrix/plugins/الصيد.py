...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 - أوامـر الصيد والتشيكـر](t.me/Matrix) 𓆪\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗲𝗽𝘁𝗵𝗼𝗻 - أنـواع اليـوزرات](t.me/Matrix) 𓆪\n\n"
...
async def hunterusername(event):
    ...
    try:
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await blal(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    about="This channel to hunt username by - @Matrix ",
        ...
        await blal.send_message(event.chat_id, f"خطأ في انشاء القناة , الخطأ**-  : {str(e)}**")
    ...
    while devmod: #code by t.me/zzzzl1l
...
async def _(event):
    ...
    try:
        ...
        ch = await blal(
            ...
            functions.channels.CreateChannelRequest(
                ...
                about="تم تثبيت اليـوزر بواسطـة سـورس تيبثـــون - @Matrix ",
    ...
    return await blal.send_message(event.chat_id, "**- تم الانتهاء من التثبيت .. بنجـاح ✅**")





@blal.dev_cmd(pattern="ثبت (.*)")
    ...
    while swapmod:
        ...
        if isav == True:
            ...
            try: # Code Update by @zzzzl1l
                ...
                await blal(functions.account.UpdateUsernameRequest(username=username))
...
@blal.dev_cmd(pattern="حالة الصيد")
...
@blal.dev_cmd(pattern="حالة التثبيت")
...
@blal.dev_cmd(pattern="ايقاف الصيد")
...
@blal.dev_cmd(pattern="ايقاف التثبيت")
