...
@blal.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@blal.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@blal.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
