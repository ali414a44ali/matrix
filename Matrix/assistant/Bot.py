...
@blal.bot_cmd(incoming=True, func=lambda e: e.is_private)
async def bot_pms(event):  # sourcery no-metrics
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if chat.id in dd:
            ...
            dd.remove(int(chat.id))
            return await event.client.send_message(chat.id, f"**ᯓ 𝙈𝙖𝙏𝙍𝙞𝙭 𝗦𝘁𝘆𝗹𝗲 - زخـرفـه تمبلـر**\n**⋆┄─┄─┄─┄┄─┄─┄─┄─┄⋆**\n{WA1} {smiile1}\n{WA2} {smiile2}\n{WA3} {smiile3}\n{WA4} {smiile4}\n{WA5} {smiile5}\n{WA6} {smiile6}\n{WA7} {smiile7}\n{WA8} {smiile8}\n{WA9} {smiile9}\n{WA10} {smiile10}\n{WA11} {smiile11}\n{WA12} {smiile12}\n{WA13} {smiile13}\n{WA14} {smiile14}\n{WA15} {smiile15}\n{WA16} {smiile16}\n{WA17} {smiile17}\n{WA18} {smiile18}\n{WA19} {smiile19}\n{WA20} {smiile20}\n{WA21} {smiile21}\n{WA22} {smiile22}\n{WA23} {smiile23}\n{WA24} {smiile24}\n{WA25} {smiile25}\n{WA26} {smiile26}\n{WA27} {smiile27}\n{WA28} {smiile28}\n{WA29} {smiile29}\n{WA30} {smiile30}\n{WA31} {smiile31}\n{WA32} {smiile32}\n{WA33} {smiile33}\n{WA34} {smiile34}\n{WA35} {smiile35}\n{WA36} {smiile36}\n{WA37} {smiile37}")
...
@blal.bot_cmd(pattern="^/info$", from_users=Config.OWNER_ID)
async def bot_start(event):
    reply_to = await reply_id(event)
    if not reply_to:
    ...
    if found:
        if flood_count >= FloodConfig.AUTOBAN:
            if user_.id in Config.SUDO_USERS:
                ...
                if BOTLOG:
                    await blal.tgbot.send_message(BOTLOG_CHATID, sudo_spam)
            else:
        ...
        if not fa_id:
            return
        try:
            msg_ = await blal.tgbot.get_messages(BOTLOG_CHATID, fa_id)
        ...
        if BOTLOG:
            fa_msg = await blal.tgbot.send_message(
                BOTLOG_CHATID,
                flood_msg,
                buttons=buttons,
            )
        try:
            chat = await blal.tgbot.get_entity(BOTLOG_CHATID)
            await blal.tgbot.send_message(
                Config.OWNER_ID,
            ...
            if BOTLOG:
                await blal.tgbot.send_message(BOTLOG_CHATID, "**- قم بالغـاء حظـر بوتك المسـاعـد ؟!**")
    if FloodConfig.ALERT[user_.id].get("fa_id") is None and fa_msg:
        FloodConfig.ALERT[user_.id]["fa_id"] = fa_msg.id


@blal.tgbot.on(CallbackQuery(data=re.compile(b"bot_pm_ban_([0-9]+)")))
@check_owner
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"toggle_bot-antiflood_off$")))
@check_owner
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"ttk_bot-1$")))
async def settings_toggle(c_q: CallbackQuery):
    await c_q.edit(
        """**- مرحبـاً بك عـزيـزي ✍🏻**
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"zzk_bot-on$")))
async def settings_toggle(c_q: CallbackQuery):
    dd.append(int(c_q.query.user_id))
    await c_q.edit("**- ارسـل الان الاسـم الذي تريـد زخرفتـه بالانكـلـش ✓**\n\n**- لـ الالغـاء ارسـل /cancle**")


@blal.tgbot.on(CallbackQuery(data=re.compile(b"ttk_bot-on$")))
async def settings_toggle(c_q: CallbackQuery):
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"ttk_bot-off$")))
async def settings_toggle(c_q: CallbackQuery):
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"styleback$")))
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"zzk_bot-1$")))
async def settings_toggle(c_q: CallbackQuery):
    try:
        await c_q.edit(
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"zzk_bot-2$")))
async def settings_toggle(c_q: CallbackQuery):
    try:
        await c_q.edit(
            """ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗦𝘁𝘆𝗹𝗲 - **رمـوز تمبلـر** 🎡
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"zzk_bot-3$")))
async def settings_toggle(c_q: CallbackQuery):
    await c_q.edit(
        """ᯓ 𝙈𝙖𝙏𝙍𝙞𝙭 𝗦𝘁𝘆𝗹𝗲 - **ارقـام مزغـرفـة** 🎡
**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**
¹ ² ³ ⁴ ⁵ ⁶ ⁷ ⁸ ⁹ ⁰
₁ ₂ ₃ ₄ ₅ ₆ ₇ ₈ ₉ ₀
———————×———————
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"zzk_bot-4$")))
async def settings_toggle(c_q: CallbackQuery):
    await c_q.edit(
        """ᯓ 𝙈𝙖𝙏𝙍𝙞𝙭 𝗦𝘁𝘆𝗹𝗲 - **ارقـام مزغـرفـة** 🎡
**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"zzk_bot-5$")))
async def settings_toggle(c_q: CallbackQuery):
    await c_q.edit(
        """ᯓ 𝙈𝙖𝙏𝙍𝙞𝙭 𝗦𝘁𝘆𝗹𝗲 - **حـذف الحسـاب** ⚠️
**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"zzk_bot-insta$")))
async def settings_toggle(c_q: CallbackQuery):
    await c_q.edit(
        """ᯓ 𝙈𝙖𝙏𝙍𝙞𝙭 - **رشـق لايكـات إنستجـرام** 🎡
**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**
...
@blal.tgbot.on(CallbackQuery(data=re.compile(b"zzk_bot-tiktok$")))
async def settings_toggle(c_q: CallbackQuery):
    await c_q.edit(
        """ᯓ 𝙈𝙖𝙏𝙍𝙞𝙭 - **رشـق مشاهـدات تيك توك** 🎡
**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**
...
@blal.bot_cmd(incoming=True, func=lambda e: e.is_private)
@blal.bot_cmd(edited=True, func=lambda e: e.is_private)
