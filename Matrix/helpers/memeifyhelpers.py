...
from wand.image import Image as devimage

from .utils import _devutils
...
async def dev_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def dev_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = devimage(filename=picture_name)
    main_image.resize(
